...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    config.vm.provision "docker" do |d|
        d.build_image "/vagrant/", args: "-t tomcat-template -f /vagrant/Dockerfile"
        # d.run "tomcat-template", args: "-p 8080:8080 -e WEBAPP_DISTRO_URL=https://github.com/daniel-rhoades/simple-jsf-example/releases/download/v0.1/simple-jsf-example.war"
        d.run "tomcat-template", args: "-p 8080:8080 --volume /tmp/distributions:/opt/cms/distributions"
    end
